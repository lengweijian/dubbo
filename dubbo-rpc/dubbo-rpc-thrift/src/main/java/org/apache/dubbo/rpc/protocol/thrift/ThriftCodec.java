 ...
 * <ol>
 * <li>string - com.atlwj.aop.service name</li>
...
//                protocol.readI32(); // skip the first message length
    ...
    private Object decode(TProtocol protocol)
        ...
        if (message.type == TMessageType.CALL) {
            ...
            if (StringUtils.isEmpty(resultClassName)) {
                throw new IllegalArgumentException("Could not infer com.atlwj.aop.service result class name from com.atlwj.aop.service name "
                        + serviceName + ", the com.atlwj.aop.service name you specified may not generated by thrift idl compiler");
            }
    ...
    private void encodeRequest(Channel channel, ChannelBuffer buffer, Request request)
        ...
        if (StringUtils.isEmpty(serviceName)) {
            throw new IllegalArgumentException("Could not find com.atlwj.aop.service name in attachment with key "
                    + INTERFACE_KEY);
        }
