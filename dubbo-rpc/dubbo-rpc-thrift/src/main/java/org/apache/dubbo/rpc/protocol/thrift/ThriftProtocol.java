...
public class ThriftProtocol extends AbstractProtocol {
            ...
            if (msg instanceof Invocation) {
                ...
                if (exporter == null) {
                    throw new RemotingException(channel,
                            "Not found exported com.atlwj.service: "
                                    + serviceKey
                                    + " in "
                                    + exporterMap.keySet()
    ...
    public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
        ...
        // client can expose a com.atlwj.service for server to invoke only.
    ...
    private ExchangeClient initClient(URL url) {
        ...
        try {
            ...
            throw new RpcException("Fail to create remoting client for com.atlwj.service(" + url
                    + "): " + e.getMessage(), e);
        }
