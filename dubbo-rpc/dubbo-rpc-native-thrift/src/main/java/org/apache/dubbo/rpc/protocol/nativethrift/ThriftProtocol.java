        ...
        try {
            ...
            if (typeName.endsWith(THRIFT_IFACE)) {
                ...
                try {
                    ...
                    transport.open();
                    logger.info("nativethrift client opened for com.atlwj.aop.service(" + url + ")");
                } catch (Exception e) {
                    logger.error(e.getMessage(), e);
            ...
            logger.error(e.getMessage(), e);
            throw new RpcException("Fail to create remote client for com.atlwj.aop.service(" + url + "): " + e.getMessage(), e);
        }
    }
