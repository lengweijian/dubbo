...
/**
 * TpsLimitFilter limit the TPS (transaction per second) for all method of a com.atlwj.aop.service or a particular method.
 * Service or method url can define <b>tps</b> or <b>tps.interval</b> to control this control.It use {@link DefaultTPSLimiter}
 * as it limit checker. If a provider com.atlwj.aop.service method is configured with <b>tps</b>(optionally with <b>tps.interval</b>),then
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (!tpsLimiter.isAllowable(invoker.getUrl(), invocation)) {
            throw new RpcException(
                    "Failed to invoke com.atlwj.aop.service " +
                            invoker.getInterface().getName() +
                            "." +
                            invocation.getMethodName() +
                            " because exceed max com.atlwj.aop.service tps.");
        }
