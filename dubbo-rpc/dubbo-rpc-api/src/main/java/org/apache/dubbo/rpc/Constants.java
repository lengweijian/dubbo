...
public interface Constants {
    ...
    String SERVICE_FILTER_KEY = "com.atlwj.aop.service.filter";
    ...
    /**
     * The limit of callback com.atlwj.aop.service instances for one interface on every client
     */
    String CALLBACK_INSTANCES_LIMIT_KEY = "callbacks";

    /**
     * The default limit number for callback com.atlwj.aop.service instances
     *
