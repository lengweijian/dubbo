...
/**
 * ActiveLimitFilter restrict the concurrent client invocation for a com.atlwj.aop.service or com.atlwj.aop.service's method from client side.
                ...
                while (!RpcStatus.beginCount(url, methodName, max)) {
                    ...
                    if (remain <= 0) {
                        throw new RpcException(RpcException.LIMIT_EXCEEDED_EXCEPTION,
                                "Waiting concurrent invoke timeout in client-side for com.atlwj.aop.service:  " +
