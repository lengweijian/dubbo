...
public class RedisProtocol extends AbstractProtocol {
    ...
    public <T> Exporter<T> export(final Invoker<T> invoker) throws RpcException {
        throw new UnsupportedOperationException("Unsupported export redis com.atlwj.aop.service. url: " + invoker.getUrl());
    }
    ...
    protected <T> Invoker<T> protocolBindingRefer(final Class<T> type, final URL url) throws RpcException {
        try {
                ...
                protected Result doInvoke(Invocation invocation) throws Throwable {
                    ...
                    try {
                        ...
                        if (get.equals(invocation.getMethodName())) {
                            ...
                            throw new UnsupportedOperationException("Unsupported method " + invocation.getMethodName() + " in redis com.atlwj.aop.service.");
                        }
                    } catch (Throwable t) {
                        RpcException re = new RpcException("Failed to invoke redis com.atlwj.aop.service method. interface: " + type.getName() + ", method: " + invocation.getMethodName() + ", url: " + url + ", cause: " + t.getMessage(), t);
            ...
            throw new RpcException("Failed to refer redis com.atlwj.aop.service. interface: " + type.getName() + ", url: " + url + ", cause: " + t.getMessage(), t);
        }
    }
