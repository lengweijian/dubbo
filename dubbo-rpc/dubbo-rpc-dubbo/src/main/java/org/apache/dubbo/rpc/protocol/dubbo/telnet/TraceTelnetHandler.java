 ...
 */
@Activate
@Help(parameter = "[com.atlwj.service] [method] [times]", summary = "Trace the com.atlwj.service.", detail = "Trace the com.atlwj.service.")
public class TraceTelnetHandler implements TelnetHandler {
    ...
    public String telnet(Channel channel, String message) {
        ...
        if (invoker != null) {
            ...
            return "No such com.atlwj.service " + service;
        }
        return null;
    }
