 ...
 */
@Activate
@Help(parameter = "[com.atlwj.aop.service.]method(args) ", summary = "Invoke the com.atlwj.aop.service method.",
        detail = "Invoke the com.atlwj.aop.service method.")
public class InvokeTelnetHandler implements TelnetHandler {
    ...
    public String telnet(Channel channel, String message) {
        ...
        if (i < 0 || !message.endsWith(")")) {
            return "Invalid parameters, format: com.atlwj.aop.service.method(args)";
        }
        ...
        if (!StringUtils.isEmpty(service)) {
            buf.append("Use default com.atlwj.aop.service ").append(service).append(".");
        }
        if (selectedProvider != null) {
            if (invokeMethod != null) {
                ...
                buf.append("\r\nNo such method ").append(method).append(" in com.atlwj.aop.service ").append(service);
            }
        } else {
            buf.append("\r\nNo such com.atlwj.aop.service ").append(service);
        }
        return buf.toString();
    }
