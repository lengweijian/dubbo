...
public class FutureFilter extends ListenableFilter {
    ...
    private void fireInvokeCallback(final Invoker<?> invoker, final Invocation invocation) {
        ...
        if (onInvokeMethod == null || onInvokeInst == null) {
            throw new IllegalStateException("com.atlwj.service:" + invoker.getUrl().getServiceKey() + " has a oninvoke callback config , but no such " + (onInvokeMethod == null ? "method" : "instance") + " found. url:" + invoker.getUrl());
        }
    ...
    private void fireReturnCallback(final Invoker<?> invoker, final Invocation invocation, final Object result) {
        ...
        if (onReturnMethod == null || onReturnInst == null) {
            throw new IllegalStateException("com.atlwj.service:" + invoker.getUrl().getServiceKey() + " has a onreturn callback config , but no such " + (onReturnMethod == null ? "method" : "instance") + " found. url:" + invoker.getUrl());
        }
    ...
    private void fireThrowCallback(final Invoker<?> invoker, final Invocation invocation, final Throwable exception) {
        ...
        if (onthrowMethod == null || onthrowInst == null) {
            throw new IllegalStateException("com.atlwj.service:" + invoker.getUrl().getServiceKey() + " has a onthrow callback config , but no such " + (onthrowMethod == null ? "method" : "instance") + " found. url:" + invoker.getUrl());
        }
