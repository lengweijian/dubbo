 ...
 */
@Activate
@Help(parameter = "[com.atlwj.aop.service] [method] [times]", summary = "Count the com.atlwj.aop.service.", detail = "Count the com.atlwj.aop.service.")
public class CountTelnetHandler implements TelnetHandler {
    ...
    public String telnet(final Channel channel, String message) {
        ...
        if (service != null && service.length() > 0) {
            buf.append("Use default com.atlwj.aop.service " + service + ".\r\n");
        }
        ...
        if (invoker != null) {
            ...
            buf.append("No such com.atlwj.aop.service " + service);
        }
        return buf.toString();
    }
