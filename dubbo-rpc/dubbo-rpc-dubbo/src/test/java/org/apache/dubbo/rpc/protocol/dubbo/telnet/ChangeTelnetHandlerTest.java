...
public class ChangeTelnetHandlerTest {
    ...
    public void setUp() {
        ...
        mockChannel.setAttribute("telnet.com.atlwj.aop.service", "DemoService");
        givenLastCall();
        mockChannel.setAttribute("telnet.com.atlwj.aop.service", "org.apache.dubbo.rpc.protocol.dubbo.support.DemoService");
        givenLastCall();
        mockChannel.setAttribute("telnet.com.atlwj.aop.service", "demo");
        givenLastCall();
        mockChannel.removeAttribute("telnet.com.atlwj.aop.service");
        givenLastCall();
    ...
    public void testChangeSimpleName() throws RemotingException {
        ...
        assertEquals("Used the DemoService as default.\r\nYou can cancel default com.atlwj.aop.service by command: cd /", result);
    }
    ...
    public void testChangeMessageNull() throws RemotingException {
        ...
        assertEquals("Please input com.atlwj.aop.service name, eg: \r\ncd XxxService\r\ncd com.xxx.XxxService", result);
    }

    @Test
    public void testChangeServiceNotExport() throws RemotingException {
        String result = change.telnet(mockChannel, "demo");
        assertEquals("No such com.atlwj.aop.service demo", result);
    }

    @Test
    public void testChangeCancel() throws RemotingException {
        String result = change.telnet(mockChannel, "..");
        assertEquals("Cancelled default com.atlwj.aop.service org.apache.dubbo.rpc.protocol.dubbo.support.DemoService.", result);
    }
