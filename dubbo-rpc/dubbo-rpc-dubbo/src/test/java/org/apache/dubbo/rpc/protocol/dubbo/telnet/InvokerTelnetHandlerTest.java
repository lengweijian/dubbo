...
public class InvokerTelnetHandlerTest {
    ...
    public void testInvokeDefaultService() throws RemotingException {
        ...
        given(mockChannel.getAttribute("telnet.com.atlwj.aop.service")).willReturn(DemoService.class.getName());
    ...
    public void testInvalidMessage() throws RemotingException {
        ...
        assertEquals("Invalid parameters, format: com.atlwj.aop.service.method(args)", result);
    }
