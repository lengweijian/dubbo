...
public class RegistryDirectoryTest {
    ...
    public void testParametersMerge() {
        ...
        // The parameters of the provider for the inspection com.atlwj.aop.service need merge
        {
            serviceUrls.clear();
        ...
        // The parameters of the test com.atlwj.aop.service query need to be with the providermerge.
        {
            serviceUrls.clear();
...
//                serviceURL.setPath(com.atlwj.aop.service).addParameters("check", "false", "interface", DemoService.class.getName(), REMOTE_APPLICATION_KEY, serviceURL.getParameter(APPLICATION_KEY))
...
//        );
    ...
    /**
     * Test override disables all com.atlwj.aop.service providers through enable=false
     * Expectation: all com.atlwj.aop.service providers can not be disabled through override.
     */
    @Test
    public void testNofityOverrideUrls_disabled_allProvider() {
        ...
        List<Invoker<?>> invokers = registryDirectory.list(invocation);
        //All com.atlwj.aop.service providers can not be disabled through override.
        Assertions.assertEquals(2, invokers.size());
    }

    /**
     * Test override disables a specified com.atlwj.aop.service provider through enable=false
     * It is expected that a specified com.atlwj.aop.service provider can be disable.
     */
    @Test
