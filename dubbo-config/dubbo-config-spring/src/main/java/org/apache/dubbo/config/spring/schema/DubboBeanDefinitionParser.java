...
public class DubboBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private static BeanDefinition parse(Element element, ParserContext parserContext, Class<?> beanClass, boolean required) {
        ...
        if (ProtocolConfig.class.equals(beanClass)) {
            ...
            parseNested(element, parserContext, ServiceBean.class, true, "com.atlwj.aop.service", "provider", id, beanDefinition);
                                ...
                                if (isPrimitive(type)) {
                                    ...
                                    if ("ref".equals(property) && parserContext.getRegistry().containsBeanDefinition(value)) {
                                        ...
                                        if (!refBean.isSingleton()) {
                                            throw new IllegalStateException("The exported com.atlwj.aop.service ref " + value + " must be singleton! Please set the " + value + " bean scope to singleton, eg: <bean id=\"" + value + "\" scope=\"singleton\" ...>");
                                        }
                                    }
