...
public abstract class AbstractServiceBuilder<T extends AbstractServiceConfig, B extends AbstractServiceBuilder<T, B>>
    ...
    /**
     * Whether to register as a dynamic com.atlwj.service or not on register center, it the value is false, the status will be disabled
     * after the com.atlwj.service registered,and it needs to be enabled manually; if you want to disable the com.atlwj.service, you also need
     * manual processing
     */
