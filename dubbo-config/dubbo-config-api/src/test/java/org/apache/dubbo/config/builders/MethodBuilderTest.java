...
class MethodBuilderTest {
    ...
    void service() {
        MethodBuilder builder = new MethodBuilder();
        builder.service("com.atlwj.aop.service");
        Assertions.assertEquals("com.atlwj.aop.service", builder.build().getService());
    }
    ...
    void build() {
        ...
        builder.name("name").stat(1).retry(true).reliable(false).executes(2).deprecated(true).sticky(false)
                .isReturn(true).oninvoke("on-invoke-object").oninvokeMethod("on-invoke-method").service("com.atlwj.aop.service")
        ...
        Assertions.assertEquals("com.atlwj.aop.service", config.getService());
