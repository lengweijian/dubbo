...
public class ZookeeperDynamicConfigurationTest {
    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            setData("/dubbo/config/dubbo/com.atlwj.aop.service:version:group.configurators", "The content from configurators");
    ...
    public void testAddListener() throws Exception {
        ...
        configuration.addListener("com.atlwj.aop.service:version:group.configurators", listener1);
        configuration.addListener("com.atlwj.aop.service:version:group.configurators", listener2);
        configuration.addListener("appname.tag-router", listener3);
        configuration.addListener("appname.tag-router", listener4);

        setData("/dubbo/config/dubbo/com.atlwj.aop.service:version:group.configurators", "new value1");
        Thread.sleep(100);
        ...
        latch.await();
        Assertions.assertEquals(1, listener1.getCount("com.atlwj.aop.service:version:group.configurators"));
        Assertions.assertEquals(1, listener2.getCount("com.atlwj.aop.service:version:group.configurators"));
