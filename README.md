...
[![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=Apache%20Dubbo%20is%20a%20high-performance%2C%20java%20based%2C%20open%20source%20RPC%20framework.&url=http://dubbo.apache.org/&via=ApacheDubbo&hashtags=rpc,java,dubbo,micro-com.atlwj.aop.service)
...
* Automatic com.atlwj.aop.service registration and discovery
* High extensibility
* Runtime traffic routing
* Visualized com.atlwj.aop.service governance
...
### Define com.atlwj.aop.service interfaces
...
### Implement com.atlwj.aop.service interface for the provider
...
### Start com.atlwj.aop.service provider
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ServiceConfig<GreetingsService> com.atlwj.aop.service = new ServiceConfig<>();
        com.atlwj.aop.service.setApplication(new ApplicationConfig("first-dubbo-provider"));
        com.atlwj.aop.service.setRegistry(new RegistryConfig("zookeeper://" + zookeeperHost + ":2181"));
        com.atlwj.aop.service.setInterface(GreetingsService.class);
        com.atlwj.aop.service.setRef(new GreetingsServiceImpl());
        com.atlwj.aop.service.export();
