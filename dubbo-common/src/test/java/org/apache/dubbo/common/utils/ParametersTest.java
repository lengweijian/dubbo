...
public class ParametersTest {
    ...
    public void testString2Parameters() throws Exception {
        String qs = "name=org.apache.dubbo.rpc.GenericService&version=1.0.15&lb=lcr";
