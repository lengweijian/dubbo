...
public class ParametersTest {
    final String ServiceName = "org.apache.dubbo.rpc.com.atlwj.aop.service.GenericService";
    final String ServiceVersion = "1.0.15";
    final String LoadBalance = "lcr";

    public void testMap2Parameters() throws Exception {
        Map<String, String> map = new HashMap<String, String>();
        map.put("name", "org.apache.dubbo.rpc.com.atlwj.aop.service.GenericService");
    ...
    public void testString2Parameters() throws Exception {
        String qs = "name=org.apache.dubbo.rpc.com.atlwj.aop.service.GenericService&version=1.0.15&lb=lcr";
