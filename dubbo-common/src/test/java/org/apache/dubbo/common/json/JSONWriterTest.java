...
public class JSONWriterTest {
    public void testWriteJson() throws Exception {
        ...
        writer.objectItem("com.atlwj.aop.service").objectBegin().objectItem("type").valueString("org.apache.dubbo.TestService").objectItem("version").valueString("1.1.0").objectEnd();
        writer.objectEnd();
    }
}