 ...
 * @see java.net.URI
 *
 * /dubbo/HelloService/consumers/consumer://192.16.2.147/
 * HelloService?application=dubbo-xml-demo-consumer&category=consumers
 * &check=false&dubbo=2.0.2&interface=HelloService&lazy=false&methods=sayHello
