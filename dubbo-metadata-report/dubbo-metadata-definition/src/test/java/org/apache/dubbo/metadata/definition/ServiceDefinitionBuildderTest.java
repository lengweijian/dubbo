...
public class ServiceDefinitionBuildderTest {
    ...
    void checkComplextObjectAsParam(FullServiceDefinition fullServiceDefinition) {
        ...
        Assertions.assertEquals(topTypeDefinition.getProperties().get("innerObject3").getType(), "org.apache.dubbo.metadata.definition.ComplexObject.InnerObject3[]");
        Assertions.assertEquals(topTypeDefinition.getProperties().get("testEnum").getType(), "org.apache.dubbo.metadata.definition.ComplexObject.TestEnum");
        Assertions.assertEquals(topTypeDefinition.getProperties().get("innerObject2").getType(), "java.util.Set<org.apache.dubbo.metadata.definition.ComplexObject$InnerObject2>");
